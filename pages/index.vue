  ...
  template(v-if="$i18n.locale == 'ja'")
    ...
    article
      section(data-fuwa)
        ...
        p こうしたプロセスを経て、最終的に、本プロジェクトが目指すアーカイヴを「Incomplete Niwa Archives 終らない庭のアーカイヴ」と命名するに至った。
...
export default {
  ...
  methods: {
    ...
    openSound() {
      window.open(
        './assets/sessyutei.mp3',
        '',
        'width=400,height=300,resizable,scrollbars,status'
      )
    }
  }
}
