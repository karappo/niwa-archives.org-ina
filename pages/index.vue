...
main
  ...
  article
    ...
    h2 「Uncompleted Niwa Archive 終らない庭のアーカイヴ」へ<br>――庭園アーカイヴ・プロジェクト 2020年度 活動レポート
    ...
    p
      | 本年度、オンラインベースの活動に移行したことによって、返って充実した開催ができたのが庭園アーカイヴ・プロジェクトYCAM研究会である。当初は、YCAMに外部講師を招聘する研究会を2020年度中に３回行い、その1回目を4月に開催する予定だったが、中止にはせずオンライン開催に移行した。そして、その内容の充実さもあって、以後は月に1回ペースでの開催の方針に移行し、年度内に計8回の研究会を開催することができた<sup class="footnote-ref"><a href="#fn1" id="fnref1">1</a></sup>。<br>
    ...
    p 当初より、2020年度からは、京都・無鄰菴庭園の調査を開始する予定であった。無鄰菴庭園は、明治27-29（1894-96）年に、山縣有朋の京都別邸としてつくられたもので、その庭園は、七代目・小川治兵衛（植治）（1860-1933）によるものである。植治は、近代日本庭園の改革者として知られるが、彼がそうした近代の新しい日本庭園の作庭を最初に実現したのが無鄰菴庭園であった。その変化はしばしば「象徴主義から自然主義」と論じられるが、具体的には、それまでの日本庭園のように海に見立てる池ではなく、疎水から引いた水流をつくり、石を立てるのではなく伏せ、東山の借景を用いる、といった点に集約される<sup>2</sup>。近年は、様々な文化活動が盛んに実施されており、全国でもっとも活発な日本庭園の一つといえよう[^3]。
    p 日本庭園は、それぞれの土地の特性を生かしてつくられるため、当然ながら、一つとして同じ庭園はない。常栄寺庭園と無鄰菴庭園の2つだけでも様々な対比が可能である<sup>4</sup>。常栄寺庭園は寺院に付随する庭であるが、無鄰菴庭園はもともと権力者の私邸の庭である。先に述べたように、常栄寺庭園は池を中心とするが、無鄰菴庭園の場合は浅い水流があるのみである。常栄寺が高低差のある構造をしているのに対して、無鄰菴はほとんど平坦な地につくられている。また、常栄寺は山の麓にあり、極めて静謐な環境にあるが、無鄰菴は平地に位置し、すぐ道路に面しており、常に自動車の往来の音が聴こえる。同じく音に関していえば、無鄰菴庭園には、先述の通り、水流があることから、絶えず水流の音が聴こえている。
    p 本年度は6月、12月に、それぞれ庭園全体の3Dスキャンを行い<sup>5</sup>、10月には、水質の調査と、無鄰菴担当庭師の出口健太氏（植彌加藤造園株式会社）、無鄰菴スタッフの平野友昭氏（植彌加藤造園株式会社）にそれぞれ無鄰菴の庭園管理、無鄰菴に集う野鳥についてのインタビューを実施した。また、10月には、庭園の定点長時間撮影・アンビソニックスによる立体音響録音の実験を行なった。
    ...
    p.footnote 2: 尼崎博正「近代庭園の濫觴」『七代目小川治兵衛――山紫水明の都にかへさねば』（ミネルヴァ書房、2012年）、38-55頁、鈴木博之「はじまりとしての山縣有朋」『庭師 小川治兵衛とその時代』（東京大学出版会、2013年）、55-98頁。植治のこうした作庭を促したのは、山県有朋の主導によるところが大きいという。
    p.footnote 3:
      | 詳しくは、
      ExternalLink(href="https://murin-an.jp") 無鄰菴ウェブサイト
      | を参照されたい。
    p.footnote 4: 無鄰菴庭園を常栄寺庭園の「うつし」とする説もある〔野村勘治『旅に出たら寄ってみたい庭 30』（小学館、1997年）、88頁〕。
    p.footnote 5: 3Dスキャンにあたっては、京都工芸繊維大学KYOTO Design Labの井上智博氏に多大な協力を得た。
